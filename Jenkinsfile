pipeline {
  ...
  stages {
    ...
    stage('SonarQube - SAST') {
          steps {
            sh "mvn clean verify sonar:sonar -Dsonar.projectKey=devsecops-demo-spingboot -Dsonar.projectName='devsecops-demo-spingboot' -Dsonar.host.url=http://asasatech.eastus.cloudapp.azure.com:9000  -Dsonar.token=sqp_c7ed70a7e8b4f9b9fb6788270834c57a64735caa"
